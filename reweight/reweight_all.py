...
path = '../paths/g4/250810_g4K_350K_20ps/scale/'  # Path to save results
...
def build_fes_rmsd(positions, RA, RB, weights, nbins=60):
    ...
    paths = ['../paths/g4/250810_g4K_350K_20ps/scale/', '../paths/g4/250810_g4K_350K_20ps_2/scale/', '../paths/g4/250810_g4K_350K_20ps_3/scale/']
    for p in paths:
        for i in range(8):
            positions = np.load(f'{p}positions/{i}.npy')
